...
$names = makeArray('xml/campus-map/NDbuildings.xml');
...
//The following code was added by Xiaojing at 11:40am on 07/13/09 to display library location in the map module. 
$libraries = find_contents('library', array('buildings'));
$gyms = find_contents('gym', array('buildings'));
//print_r ($food);
$building_data = array();
