...
class Page {
  ...
  public static function classify_phone() {
    ...
    if($_SERVER['HTTP_USER_AGENT']) {      
      $type = file_get_contents("http://localhost/wurfl/api?UserAgent=" . urlencode($_SERVER['HTTP_USER_AGENT']));	  
    } else {
      $type = "feature_phone";
    }
    */
	/*Added by Xiaojing at 9:32am on 06/05/09 to make the default phone to be iphone.*/
	$type = "iphone";
