...
$Month = Month($month); 
$prev_url = "exhibits.php?year={$prev_yr}&month={$prev['month']}";
$next_url = "exhibits.php?year={$next_yr}&month={$next['month']}";
